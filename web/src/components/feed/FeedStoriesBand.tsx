export function FeedStoriesBand() {
  return (
    <>
      <div className="_feed_inner_ppl_card _mar_b16 d-none d-md-block">
        ...
        <div className="row">
          ...
          {["card_ppl2.png", "card_ppl3.png", "card_ppl4.png"].map((img, idx) => (
            <div
              key={img}
              className={`col-xl-3 col-lg-3 col-md-4 col-sm-4 col${idx === 1 ? " _custom_mobile_none" : ""}${idx === 2 ? " _custom_none" : ""}`}
            >
              <div className="_feed_inner_public_story _b_radious6">
                <div className="_feed_inner_public_story_image">
                  <img src={`/assets/images/${img}`} alt="" className="_public_story_img" />
      ...
      <div className="_feed_inner_ppl_card_mobile _mar_b16 d-md-none">
        <div className="_feed_inner_ppl_card_area">
          <ul className="_feed_inner_ppl_card_area_list">
            ...
            {["mobile_story_img1.png", "mobile_story_img2.png", "mobile_story_img1.png"].map((m, i) => (
              <li key={i} className="_feed_inner_ppl_card_area_item">
                <a href="#0" className="_feed_inner_ppl_card_area_link">
                  ...
                  >
                    <img src={`/assets/images/${m}`} alt="" className="_card_story_img1" />
                  </div>
