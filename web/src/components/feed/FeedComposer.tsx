...
export function FeedComposer({ avatarSrc, onCreated }: Props) {
  ...
  function setFileFromInput(files: FileList | null) {
    const file = files?.[0];
  ...
  async function submit() {
    ...
    try {
      ...
      if (file) {
        ...
        if (!r.ok) {
          throw new ApiError(data.error || "Failed", r.status, data);
        }
        res = data;
      } else {
        res = await apiJson<{ post: Post }>("/api/posts", {
          method: "POST",
  ...
  return (
    <div className="_feed_inner_text_area  _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
      ...
      <input
        ...
        hidden
        onChange={(e) => setFileFromInput(e.target.files)}
      />
      {imagePreview ? (
        <div className="_feed_inner_timeline_image _mar_t12 _mar_b8" style={{ position: "relative" }}>
      ...
      {err ? (
        <p className="_feed_inner_timeline_post_box_para _mar_b8" style={{ color: "#c53030" }}>
          {err}
        </p>
      ) : null}
      <p className="_feed_inner_timeline_post_box_para _mar_b8">
        <a
          ...
          style={{ fontWeight: visibility === "public" ? 600 : 400 }}
        >
          Public
        </a>
        {" . "}
        <a
          ...
          style={{ fontWeight: visibility === "private" ? 600 : 400 }}
        >
          Private
        </a>
      </p>
      <div className="_feed_inner_text_area_bottom">
        ...
        <div className="_feed_inner_text_area_btn">
          <button type="button" className="_feed_inner_text_area_btn_link" onClick={submit} disabled={busy}>
            <svg
              className="_mar_img"
              xmlns="http://www.w3.org/2000/svg"
              width="14"
