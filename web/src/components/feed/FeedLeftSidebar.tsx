/* Static left column from feed.html — Explore, Suggested People, Events */
    ...
    <div className="_layout_left_sidebar_wrap">
        ...
        <div className="_layout_left_sidebar_inner">
          <div className="_left_inner_area_suggest _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
            ...
            {[
              { img: "/assets/images/people1.png", cls: "_info_img", name: "Steve Jobs", role: "CEO of Apple" },
              { img: "/assets/images/people2.png", cls: "_info_img1", name: "Ryan Roslansky", role: "CEO of Linkedin" },
              { img: "/assets/images/people3.png", cls: "_info_img1", name: "Dylan Field", role: "CEO of Figma" },
            ].map((p) => (
              <div key={p.name} className="_left_inner_area_suggest_info">
                <div className="_left_inner_area_suggest_info_box">
                  <div className="_left_inner_area_suggest_info_image">
                    <a href="#0">
                      <img src={p.img} alt="" className={p.cls} />
                    </a>
                  </div>
