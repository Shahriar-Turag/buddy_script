...
export function FeedLayoutMode() {
  const [dark, setDark] = useState(false);

  useEffect(() => {
    const el = document.querySelector("._layout_main_wrapper");
    if (!el) return;
    if (dark) el.classList.add("_dark_wrapper");
    else el.classList.remove("_dark_wrapper");
  }, [dark]);
